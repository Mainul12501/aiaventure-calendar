...
* @copyright 2017-2023
* @version $Id: controller.php, v1.2 Feb 2023 transinova $
*/
...
//ajax call to get vdata
if (isset($_GET['r']) && $_GET['r']== 'get-vehicle'){
    $catName = htmlentities($_GET['cat']);
    $query = 'SELECT * from property_types where category="'.$catName.'"';

    print json_encode($db->fetch_all($query));
}
?>