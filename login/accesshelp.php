...
<div class="dropdown">
  <button class="btn btn-default dropdown-toggle float-end" type="button" id="dropdownMenu1" data-bs-toggle="dropdown" aria-expanded="true"> <span class="glyphicon glyphicon-globe" aria-hidden="true"></span>
