...
<div class="dropdown">
  <button class="btn btn-default dropdown-toggle float-end" type="button" id="dropdownMenu1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <span class="glyphicon glyphicon-globe" aria-hidden="true"></span>
  ...
  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenu1">
    ...
    <div class="rowspan">  
        <form method="post" enctype="multipart/form-data" class="form-signin">
          ...
          <div class="logo mb-5"><img src="<?php echo SITEURL."assets/images/logo.png"?>" alt="<?php echo $gist->pptname ?>">
      ...
      <div class="rowspan access-footer"> <a href="accesshelp.php"><?php echo Lang::$say->_UR_PASSWORDFG?>?</a><?php if($gist->showpubliccal){?><a class="float-end" href="../"><?php echo Lang::$say->_GNL_PUBLICVIEWCAL?></a><?php }?> </div>
      </div>
      </div>
    </div>
  </div>
