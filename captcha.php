...
$BASECPATH = str_replace("captcha.php", "", realpath(__FILE__));
$string='';
$chars = 5; $i = 0; while ($i < $chars){
	$string .= substr($charlist, mt_rand(0, strlen($charlist)-1), 1); $i++;
	} 
$_SESSION['tivrbc120cal_captchacode'] = $string;
$rotweim=rand(1,4);
$height = 35; 
$width = 130;
...
imagettftext($captcha, 26, $rotwe, $vx, 27, $col, $BASECPATH.'assets/fonts/monofont.ttf', $string[$q]);
$char++;
 }
