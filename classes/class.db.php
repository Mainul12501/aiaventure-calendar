<?php
   ...
   * @copyright 2017-2023
   * @version $Id: class.db.php, v1.2 Feb 2023 transinova $
   */
  ...
  class Database
  {
      ...
      public function connect()
      {
		  ...
		  mysqli_query($this->link_id,"SET SESSION sql_mode=''");	  
      ...
      public function query($sql)
      {
          if (trim($sql != "")) {
			  ...
			  mysqli_query($this->link_id,"SET SESSION sql_mode = 'TRADITIONAL,ALLOW_INVALID_DATES'");
      ...
      {
          $this->query("SET SESSION sql_mode = 'TRADITIONAL,ALLOW_INVALID_DATES'");
      ...
      {
          //mysqli_query($this->link_id, "SET sql_mode = 'TRADITIONAL,ALLOW_INVALID_DATES'");
		  $this->query("SET SESSION sql_mode = 'TRADITIONAL,ALLOW_INVALID_DATES'");
