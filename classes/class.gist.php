<?php
   ...
   * @copyright 2017-2023
   * @version $Id: class.gist.php, v1.2 Feb 2023 transinova $
   */
  ...
  class Gist
  {
	  ...
	  public function setConfig()
	  {
		  ...
		  if(isset($_POST['sysfrontlanguage'])){$sysfrontlanguage=sanitize($_POST['sysfrontlanguage']);}else{$sysfrontlanguage='en';}
...
$disp = '
        <form class="form" id="form_emailtpledit">
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                <label for="fname">'.Lang::$say->_GNL_EMAILTPLSBJ.' '.Lang::$say->_FOR.': '.$row->name.' <span class="badge text-bg-secondary">'.Vault::get("Lang")->currlang.'</label>
		  ...
		  <div class="col-sm-12">
		  <div class="form-group">
		  <label for="body'.Lang::$lang.'">'.Lang::$say->_GNL_EMAILTPLBODY.' <span class="badge text-bg-secondary">'.Vault::get("Lang")->currlang.'</label>
...
';
       ...
       * @return
       */
      public function getLanguageList($setlang=false)
	  {
...
<div class="col-sm-3">
<label for="direction" class="label-mb">'.Lang::$say->_LANGDIRECTION.'</label>
...
<div class="col-sm-3" class="label-mb"><label class="hidden-xs">&nbsp;</label>
<div class="form-group">
...
$disp .= '<li><a class="dropdown-item langitem" href="javascript:void(0);" data-lang="'.$row->abbr.'">'.$row->name.' ('.$row->abbr.') '.$ceked.'</a></li>';}

		  }
unset($row);
}else{
$notypes='<ul class="nav-item">'.Lang::$say->_LANGNAME_R.'</ul>';  }
