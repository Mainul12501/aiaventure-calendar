...
<?php if(!isset($_GET['do']) || !$_GET['do']){
    ...
    <div class="card panel-default">
        ...
        <div class="card-body" id="panel_pptconfig">
            <form class="form" id="form_pptconfig">
                <div class="row">
                    <div class="col-sm-12">
                        <label class="bolder mb-3"><?php echo Lang::$say->_PPT_DETAILS ?></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-10">
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            <label class="checkbox-inline label-mt">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="bolder mb-3"><?php echo Lang::$say->_GNL_SYSOPTS ?></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-3">
                        <label for="sysuicorners" class="label-mb"><?php echo Lang::$say->_UIOPTIONS ?></label>
                        <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <label for="notification" class="label-mb"><?php echo Lang::$say->_GNL_NOTIFYWHEN ?></label>
                        <div class="form-group">
                            <label class="checkbox-inline">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="bolder mb-3"><?php echo Lang::$say->_GNL_PUBLICVECALOPTS ?></label>
                    </div>
                    <div class="col-sm-4">
                        <label for="showpubliccal" class="label-mb"><?php echo Lang::$say->_GNL_PUBLICVECAL ?></label>
                        <div class="form-group">
                            <label class="checkbox-inline">
                    ...
                    <div class="col-sm-4">
                        <label for="publiccalurlonly" class="label-mb"><?php echo Lang::$say->_GNL_PCV_PERPTVIEW ?></label>
                        <div class="form-group">
                            <label class="checkbox-inline">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="bolder mb-3" for="notification"><?php echo Lang::$say->_BKG_EXPCALOPTS ?></label>
    ...
    <div class="card panel-default">
        ...
        <div class="card-body panel_ppttypeadd panel_ppttypeedit panel_ppttypedel">
            <div class="row">
                <div class="col-lg-12"> <a class="btn btn-default float-end" id="showmodaldlg_ppttypeadd" href="javascript:void(0);"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo Lang::$say->_PPT_ADDTYPE ?></a></div>
            </div>
    ...
    <div class="modal fade" id="modaldlg_ppttypeadd" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
<!--                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-plus"></span> --><?php //echo Lang::$say->_PPT_ADDTYPE ?><!--</h1>-->
                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-plus"></span> Add Vehicle</h1>
                ...
                <div  id="panel_ppttypeadd" class="modal-body">
                    <form class="form" id="form_ppttypeadd">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="categories"><?php echo Lang::$say->_PPT_SECCATEGORY ?></label>
...
<!--                                    <label for="ptypename">--><?php //echo Lang::$say->_PPT_TYPE ?><!--</label>-->
                                    <label for="ptypename">Vehicle Name</label>
    ...
    <div class="modal fade" id="modaldlg_ppttypeedit" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
<!--                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-pencil"></span> --><?php //echo Lang::$say->_PPT_EDITTYPE ?><!--</h1>-->
                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-pencil"></span> Edit Vehicle</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Lang::$say->_CLOSE ?>"></button>
                </div>
    ...
    <div class="modal fade" id="modaldlg_blockstatedit" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-pencil"></span> <?php echo Lang::$say->_PPT_BLSTEDIT ?></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Lang::$say->_CLOSE ?>"></button>
                </div>
    ...
    <div class="modal fade" id="modaldlg_emailtpledit" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-pencil"></span> <?php echo Lang::$say->_GNL_EDITEMAILTPL ?></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Lang::$say->_CLOSE ?>"></button>
                </div>
...
<?php if(isset($_GET['do']) && $_GET['do']=='language'){
    ...
    <div class="card panel-default">
        ...
        <div class="card-body panel_langadd panel_langedit panel_langdel">
            <div class="row">
                <div class="col-lg-12"> <a class="btn btn-default float-end" id="showmodaldlg_langadd" href="javascript:void(0);"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo Lang::$say->_LANGADD ?></a></div>
            </div>
            <div class="clearfix"><br />
            </div>
            <div class="row">
    ...
    <div class="modal fade" id="modaldlg_langadd" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-plus"></span> <?php echo Lang::$say->_LANGADD ?></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Lang::$say->_CLOSE ?>"></button>
                </div>
                <div  id="panel_langadd" class="modal-body">
                    <form class="form" id="form_langadd">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label for="direction" class="label-mb"><?php echo Lang::$say->_LANGDIRECTION ?></label>
                            ...
                            <div class="col-sm-2">
                                <label class="hidden-xs">&nbsp;</label>
                                <div class="form-group">
                                    <label class="checkbox-inline label-mb">
    ...
    <div class="modal fade" id="modaldlg_langedit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5"><span class="glyphicon glyphicon-pencil"></span> <?php echo Lang::$say->_LANGEDIT ?></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Lang::$say->_CLOSE ?>"></button>
                </div>
