...
?>
<h1><?php echo $blocklist_title ?><a target="_blank" class="float-end printmodebutton" href="printmode.php?do=blocks"><span class="glyphicon glyphicon-print"></span></a></h1>
