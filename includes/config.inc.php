...
define('CFG_URL', 'http://localhost/calendar');
...
define('DB_DATABASE', 't_five'); //MySQL Database Name

define('CFG_TZ', 'Asia/Dhaka'); // Change the TimeZone with yours. e.g. America/Los_Angeles
									// See the list at: http://php.net/manual/en/timezones.php

define('CFG_WEEKSTART', '1'); // Weekstart. 1:Sunday / 2:Monday
