...
?>        
        <li class="nav-item dropdown"><a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown" aria-expanded="false"><?php echo Lang::$say->_UR_USERS;?> <span class="caret"></span></a>
          <ul class="dropdown-menu">
<li><a class="dropdown-item" href="users.php"><?php echo Lang::$say->_UR_USERS;?></a></li>
<li><a class="dropdown-item" href="users.php?do=assign"><?php echo Lang::$say->_UR_ASSIGNMENT;?></a></li>        
          </ul>        
        </li>
        <li class="nav-item dropdown"><a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown" aria-expanded="false"><?php echo Lang::$say->_GNL_SETTINGS;?> <span class="caret"></span></a>
          <ul class="dropdown-menu">
<li><a class="dropdown-item" href="settings.php"><?php echo Lang::$say->_GNL_SETTINGS;?></a></li>
<li><a class="dropdown-item" href="settings.php?do=language"><?php echo Lang::$say->_LANGUAGES;?></a></li>       
          </ul>        
        </li>
<?php 
}
...
<?php }?>  
<li class="nav-item dropdown"><a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $user->username ?> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="account.php"><?php echo Lang::$say->_UA_UPDATE;?></a></li>
            <li><a class="dropdown-item" href="account.php?do=links"><?php echo Lang::$say->_LINKS;?></a></li>
            <li><hr class="dropdown-divider"></li>
            <?php if($gist->showpubliccal){ ?>            
            <li><a class="dropdown-item" href="./" target="_blank"><?php echo Lang::$say->_GNL_VIEWPUBLICCAL;?></a></li>
            <li><hr class="dropdown-divider"></li>
            <?php } ?>
            <li><a class="dropdown-item" href="login/?logout=true"><?php echo Lang::$say->_LOGOUT;?></a></li>
          </ul>
        </li>
<li class="nav-item dropdown"><a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> <?php echo Vault::get("Lang")->currlang ?> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-end">
